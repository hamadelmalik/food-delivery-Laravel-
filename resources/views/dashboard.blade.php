...
<body class="bg-gray-100 h-screen flex">
    ...
    <aside class="w-64 bg-white shadow-md p-4">
        ...
        <nav class="flex flex-col gap-2">
            ...
            <a href="{{ route('products.create') }}" class="p-2 rounded hover:bg-gray-200">Products</a>
             <a href="{{ route('option-types.index') }}" class="p-2 rounded hover:bg-gray-200">Option Types</a> <!-- جديد -->
